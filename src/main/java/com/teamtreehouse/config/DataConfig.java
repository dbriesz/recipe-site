...
public class DataConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(env.getProperty("recipe-site.entity.package"));
    ...
    public DataSource dataSource() {
        ...
        // Driver class name
        ds.setDriverClassName(env.getProperty("recipe-site.db.driver"));

        // Set URL
        ds.setUrl(env.getProperty("recipe-site.db.url"));

        // Set username & password
        ds.setUsername(env.getProperty("recipe-site.db.username"));
        ds.setPassword(env.getProperty("recipe-site.db.password"));
